package net.shyshkin.study.blog.service;

import java.time.Instant;
import java.util.*;
import java.util.stream.Collectors;
import net.shyshkin.study.blog.config.Constants;
import net.shyshkin.study.blog.domain.Authority;
import net.shyshkin.study.blog.domain.User;
import net.shyshkin.study.blog.repository.AuthorityRepository;
import net.shyshkin.study.blog.repository.UserRepository;
import net.shyshkin.study.blog.security.SecurityUtils;
import net.shyshkin.study.blog.service.dto.AdminUserDTO;
import net.shyshkin.study.blog.service.dto.UserDTO;
