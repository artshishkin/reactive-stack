...
import net.shyshkin.study.blog.repository.BlogRepository;
import net.shyshkin.study.blog.repository.UserRepository;
import net.shyshkin.study.blog.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link net.shyshkin.study.blog.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
