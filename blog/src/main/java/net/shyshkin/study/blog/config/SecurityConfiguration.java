package net.shyshkin.study.blog.config;
...
import net.shyshkin.study.blog.security.oauth2.AudienceValidator;
import net.shyshkin.study.blog.security.oauth2.JwtGrantedAuthorityConverter;
