package net.shyshkin.study.store.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("net.shyshkin.study.store.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("net.shyshkin.study.store.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
