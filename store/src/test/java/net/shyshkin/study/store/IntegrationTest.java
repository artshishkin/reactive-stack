package net.shyshkin.study.store;

import java.lang.annotation.ElementType;
import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;
import java.lang.annotation.Target;
import net.shyshkin.study.store.StoreApp;
import net.shyshkin.study.store.config.AsyncSyncConfiguration;
import net.shyshkin.study.store.config.EmbeddedMongo;
import net.shyshkin.study.store.config.TestSecurityConfiguration;
