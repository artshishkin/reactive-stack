...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("net.shyshkin.study.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("net.shyshkin.study.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
