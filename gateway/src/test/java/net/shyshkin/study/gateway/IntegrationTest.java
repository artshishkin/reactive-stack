...
import net.shyshkin.study.gateway.GatewayApp;
import net.shyshkin.study.gateway.config.AsyncSyncConfiguration;
import net.shyshkin.study.gateway.config.EmbeddedSQL;
